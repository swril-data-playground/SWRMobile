...
import { AutoAcceptCredential, AutoAcceptProof, HttpOutboundTransport , WsOutboundTransport } from '@aries-framework/core'
...
export class BaseAgent {
  ...
  public constructor(walletId: string,name: string , key: string) {
    ...
    const config: InitConfig = {
      ...
      //endpoints: [`http://localhost:${this.port}`],//for P2P connection
    ...
    }//Remainder-Channel and chaincode init
