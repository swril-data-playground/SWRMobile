import type { KeyPair } from './utils/crypto/SigningProvider'
import type {
  EncryptedMessage,
  KeyDerivationMethod,
  WalletConfig,
...
} from '/home/narukirito/SWRMobileAries/src/utils/types'
...
import type {
  ...
  WalletVerifyOptions,
  Wallet,
} from '/home/narukirito/SWRMobileAries/src/wallet/wallet'
import type { default as Indy, WalletStorageConfig } from 'indy-sdk-react-native'

import { inject, injectable } from 'tsyringe'

import { AgentDependencies } from '/home/narukirito/SWRMobileAries/src/agentdec/AgentDependencies'
import { InjectionSymbols } from '/home/narukirito/SWRMobileAries/src/app/constants'
import { Key  , KeyType} from '/home/narukirito/SWRMobileAries/src/wallet/utils/crypto'
//import { SigningProviderRegistry } from '../crypto/signing-provider/SigningProviderRegistry'
import { AriesFrameworkError, IndySdkError, RecordDuplicateError, RecordNotFoundError } from '/home/narukirito/SWRMobileAries/src/wallet/error'
import { Logger } from '/home/narukirito/SWRMobileAries/src/wallet/logger'
import { TypedArrayEncoder } from '/home/narukirito/SWRMobileAries/src/wallet/utils/TypedArrayEncoder'
import { JsonEncoder } from '/home/narukirito/SWRMobileAries/src/wallet/utils/JsonEncoder'
import { isError } from '/home/narukirito/SWRMobileAries/src/wallet/error/isError'
import { isIndyError } from '/home/narukirito/SWRMobileAries/src/wallet/error/indyError'

import { WalletDuplicateError, WalletError, WalletNotFoundError  , WalletInvalidKeyError} from '/home/narukirito/SWRMobileAries/src/wallet/error'

@injectable()
export class SWRWallet implements Wallet {
