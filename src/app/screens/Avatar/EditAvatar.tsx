  ...
  return (
    <View style={gs.scrollParent}>
      ...
      <ScrollView style={gs.screenPadding}>
        ...
        <SWRText style={styles.headerSubTextDesign}>
          {" "}
          You can give your Avatar different glasses,heads, bodies and
        ...
        <View style={{ marginLeft: "auto", marginTop: -40 }}>
          ...
          >
            <Image
              source={images.randomize_icon}
              style={styles.randomizeIconStyle}
            />
          </SWRButton>
        </View>
