...
// import { genderTypes, questionTypes, religionTypes } from 'types/account'
...
export const EditProfile = () => {
	...
	return (
		...
		{/* 		<View style={styles.containerStyle}>
					...
					<View style={[styles.dobContainerStyle, styles.editprofileTextDesign]}>
						<View>
					...
					<View style={styles.containerStyleGradeAndPostal}>
						<View>
							...
							<SWRTextInput containerStyle={styles.heightWidthDesign} inputStyle={styles.inputTextDesign} name={'Grade'} onChange={(data) => setGrade(data)} value={grade} withTitle />
						</View>
					...
					<SWRButton style={[styles.whiteSection, styles.linkButton]} onPress={() => {}}>
